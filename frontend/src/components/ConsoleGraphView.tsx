...
interface ConsoleGraphViewProps {
...
const GraphContent: React.FC<ConsoleGraphViewProps> = ({ graphData, onSelectProgram, onIngest, loading }) => {
...
export const ConsoleGraphView: React.FC<ConsoleGraphViewProps> = (props) => (
  <ReactFlowProvider>
    <GraphContent {...props} />
  </ReactFlowProvider>
);
